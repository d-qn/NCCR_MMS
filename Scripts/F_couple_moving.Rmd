...
b102f <- tibble(
  ...
  b10 = c("Partner already in Switzerland", 
          "Partner moved before", ## hack swap 2 & 3
           "Moved together",  ## hack swap 2 & 3
          "Partner moved after", 
          "Partner has not moved yet")
  )
b102f %<>% 
  mutate(
    b10 = factor(b10, levels = b102f$b10[c(3,1,2, 4, 5)]) #b102f$b10[c(2,1, 3, 4, 5)])
  )
...
cou_msa_df %<>% 
  mutate(
    ...
    label = str_c(
      ...
      b10, "</span>: <span style='color:#878f92;font-size:14px;'>", share, "%</span>"),
  )
...
p_coum_3 <- cou_msa_df %>% 
  ...
  labs(
    title = str_c(
      "Migrating as a couple: only 1 in 5 ",
