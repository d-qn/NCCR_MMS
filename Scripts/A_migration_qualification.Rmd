...
edu_chart2 <- edu_all_genre %>% 
  ...
  theme(
    ...
    legend.text = element_text(size = 8, 
                               color = legend_base_col), # Reduce legend text size
    legend.title = element_text(size = 10, 
                                color = legend_base_col, face = "bold", 
  ...
  scale_y_continuous(expand = c(0.015,0.015), name = "", 
                     ...
                     position = "right") +
  scale_colour_manual(
    values=c(nccr_bi_colors[c(1,3)], "#898989")) +
...
arrow_txt <-
  tibble(
    x1 = annot_sub$type-c(1,1.5),
    x2 = annot_sub$type,
    y1 = annot_sub$share_w-c(3,4),
