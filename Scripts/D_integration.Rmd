...
p_ints_1 <- ints_df %>% 
 ggplot(
  ...
  geom_label(
    x=3.9, aes(y=label_pos, label=label), size=2,
...
patchwork <- ((p_ints_1 /p_ints_2/p_ints_4) +
  plot_layout(heights = c(1,1.1,1), widths = 1, ncol = 1, guides = "collect") | (p_ints_3a) +
    plot_layout(heights = c(1),  widths = 1, ncol = 1, guides = "collect")) +
