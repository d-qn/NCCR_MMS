...
p_ints_1 <- ints_df %>% 
 ggplot(
  ...
  geom_label(
    x=3.9, aes(y=label_pos, label=label), size=2.5,
...
p_ints_3a <- p_ints_3 +
  ...
  geom_richtext(
    ...
    title = str_c("Migrants from Germany and France tend to be high-skilled"),
...
p_ints_4 <- ints_sexe_df %>%
  ...
  labs(
    title = str_c(
      "Men migrants tend to be more high-skilled"),
    subtitle = str_c(
...
patchwork <- ((p_ints_1 /p_ints_2/p_ints_4) +
  plot_layout(heights = c(1,1.1,1), widths = 1, ncol = 1) | (p_ints_3a) +
