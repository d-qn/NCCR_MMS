...
annot_df <- tibble(
  ...
  h16 = factor(c("Stay", "Don't know", "Leave"), 
                levels = c("Leave",  "Don't know", "Stay"))
)  

sld_col <- nccr_colors_6[c(5,2,9)]
...
p_sl_1 <- sl_df %>% 
  ...
  labs(
    ...
    subtitle = str_c(
      ...
      "<span style='color:", sld_col[3], ";'><b>stay</b></span> in Switzerland, ", 
       "<span style='color:", sld_col[1], ";'><b>leave</span> or who are ",      
      "<span style='color:", sld_col[2], ";'><b>undecided</span>, ",      
      " by survey year"
    )) +
  scale_fill_manual(values = sld_col) +
  geom_richtext(data = annot_df, aes(
    x = year, y = share_w, label = txt, group = h16),
 ...
 scale_y_continuous(
  ...
  labs(
   ...
   subtitle = str_c(
      ...
      "<span style='color:", sld_col[3], ";'><b>stay</b></span> in Switzerland, ", 
       "<span style='color:", sld_col[1], ";'><b>leave</b></span> or who are ",      
      "<span style='color:", sld_col[2], ";'><b>undecided</b></span>",      
      " in 2024"
    )) +
   geom_richtext(
     data = slc_labels_df,
...
mms_export_vector(
  plot = patchwork,
  filepath = here("Output", "charts", "6_J_stay_leave.svg"),
  bg_col = pw_bg_color
  )
