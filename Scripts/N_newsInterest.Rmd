...
p_ni_1a <- nic_df %>% 
  ...
  theme(
    ...
    #panel.ontop = TRUE
    axis.text.x = element_text(size = 12, marrgin=margin(t=75))
  ) +
  ...
  labs(
    title = "Interest in news & politics (children's country)",
    subtitle = "By migration duration"
  ) +
  geom_text(
