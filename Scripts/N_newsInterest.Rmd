...
p_ni_1a <- nic_df %>% 
  ...
  theme(
    ...
    axis.title.y = element_textbox_simple(
      ...
      fill = nccr_bi_colors[13] %>% lighten(0.7),
...
patchwork <- plot_final +
  ...
  plot_annotation(
    ...
    subtitle = str_c("Level of interest: ",
                    ...
                    "/<span style='color:", nih_cols[1], ";'><b>low</b></span>, ",
                    "<span style='color:", ni_cols[2], ";'><b>moderate</b></span>",
                    "/<span style='color:", nih_cols[2], ";'><b>moderate</b></span>, ",
                    "<span style='color:", ni_cols[3], ";'><b>high</b></span>",
                    "/<span style='color:", nih_cols[3], ";'><b>high</b></span>",
