...
wcond5_p_df %>% 
 ...
 scale_y_continuous(
  ...
  annotate("text", x = nlevels(wcond5_p_df$pays), y = -0.02, 
           label = "Amélioré", vjust = -3, hjust = 1, size = 3, 
           family = mms_base_family, fontface = "bold") +
  annotate("text", x = nlevels(wcond5_p_df$pays), y = 1.02, 
           label = "Détérioration", vjust = -3, hjust = 0, size = 3, 
           family = mms_base_family, fontface = "bold") 
