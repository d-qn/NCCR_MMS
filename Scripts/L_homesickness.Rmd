...
ho_c_labels <- ho_c_df %>%
  ...
  mutate(
    weak_lbl = paste0("<span style='color:", darken(genderg_col[3], 0.3), ";'>", round(weak, 0), "%</span>"),
    mid_lbl = paste0("<span style='color:", "white", ";'>", round(mid, 0), "</span>"),
    strong_lbl = paste0("<span style='color:", "white", ";'>", round(strong, 0), "</span>")
  ) %>%
  mutate(
    y = 0.005,
