...
p_fri_1 <- fri_df %>% 
  ...
  geom_area(
    aes(fill = g6), 
    alpha = 1, linewidth = 0.5, color = "white") +
  theme_mms(
    grid="XY", axis="XY", 
  ...
  labs(
    ...
    subtitle = str_c(
      ...
      "<span style='color:", nccr_bi_colors[8], ";'><b>mostly in Switzerland</b></span>, ", 
       "<span style='color:", nccr_bi_colors[13], ";'><b>mixed</b></span> or ",      
      "<span style='color:", nccr_bi_colors[4], ";'><b>mostly abroad</b></span>, ",
      " by survey year"
    )) +
  scale_fill_manual(values =nccr_bi_colors[c(8,13,4)]) +
...
p_fri_3 <- fric_df %>% 
  ...
  scale_color_manual(values = nccr_bi_colors[c(8,13,4)]) +
  labs(
    ...
    subtitle = str_c(
      ...
      "<span style='color:", nccr_bi_colors[7], ";'><b>mostly in Switzerland</b></span>, ", 
       "<span style='color:", nccr_bi_colors[13], ";'><b>mixed</b></span> or ",      
      "<span style='color:", nccr_bi_colors[3], ";'><b>mostly abroad</b></span>"
    )
  ) +
  ...
  geom_text(data = fric_2_df,
            ...
            vjust = 0, hjust = 0.5, nudge_y = nudge_y_txt,
            size = 2.5, color = nccr_bi_colors[4], family = mms_base_family)
...
p_fri_4 <- frimg_df %>% 
  ...
  scale_fill_manual(values = nccr_bi_colors[c(8,4)]) +
  labs(
    ...
    subtitle = str_c(
      "Presence, ",
      "<span style='color:", nccr_bi_colors[4], ";'><b>yes</b></span> or ",
      "<span style='color:", nccr_bi_colors[8], ";'><b>no</b></span>, ",
