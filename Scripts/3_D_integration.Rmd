...
p_ints_3a <- p_ints_3 +
  ...
  geom_richtext(
    ...
    fill = NA, label.color = NA,# remove background and outline,
    vjust = 1, nudge_y = -0.1, size = 3, alpha = 1, colour = "white",
    family = mms_base_family
   ) + labs(
  ...
  annotate("text", x = 0, y = nlevels(ints_pays_df$country) - 0.3,
           label = "Suited", vjust = 1, hjust = 0, 
           size = 4,
           family = mms_base_family, fontface = "bold",
           color = nccr_colors_3[8]) +
  annotate("text", x = 100, y = nlevels(ints_pays_df$country) -0.3,
           label = "Not suited", vjust = 1, hjust = 1, 
           size = 4,
           family = mms_base_family, fontface = "bold",
           color = nccr_colors_3[2]) +
...
p_ints_4 <- ints_sexe_df %>%
  ...
  labs(
    title = str_c(
      "Men migrants more often view their education well-suited to their job"),
    subtitle = str_c(
