...
mig_chart2_a <- mig_chart2 + 
  ...
  labs(
    ...
    caption = "La hauteur des barres est proportionnelle à la taille de l’échantillon (n)"
  )
  ...
  geom_richtext(data = pimt_sub,
                ...
                aes(x = share_non, y = year, 
                    ...
                    label = paste0(prettyNum(share_non, digits = 3),
                                   " %")),
                size = 3,
                vjust = 0, nudge_y = 0.17, colour = "darkgrey"
  ) +
