...
mig_chart1 <- migm_df %>% 
  ...
  theme(legend.position = c(0.98, 0.17),
  ...
  labs(
    ...
    subtitle="Proportion de personnes en couple au moment de migrer")
...
col_seul <- "#c9d175" #darken("#c9d175", 0.3)
...
mig_chart2_a <- mig_chart2 + 
  ...
  geom_richtext(
    ...
    fill = NA, label.color = NA,# remove background and outline,
    vjust = 1, size = 4, alpha = 0.75, colour = "white",
