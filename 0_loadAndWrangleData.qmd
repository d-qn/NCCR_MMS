...
mig_chart1 <- migm_df %>% 
  ...
  theme(legend.position = c(0.98, 0.22),
...
mig_chart2_a <- mig_chart2 + 
  ...
  geom_richtext(
    ...
    fill = NA, label.color = NA,# remove background and outline,
    vjust = 1, size = 4, alpha = 0.8, colour = "white",
...
E38
1.      Yes, fully appropriate
2.      Yes, rather appropriate
3.      No, not really appropriate
4.      No, absolutely not appropriate
-9. No answer
...
pimt_sub %>% 
  ...
  scale_x_continuous(name = "", expand = c(0.1,0.1), 
                     labels = NULL, position = "top",
